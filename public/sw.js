// RM-Pocket Service Worker
const CACHE_NAME = "rm-pocket-v1";
...
self.addEventListener("push", (event) => {
  let data = { title: "RM-Pocket", body: "Ada pembaruan terbaru", icon: "/icons/icon-192x192.png" };
  ...
  event.waitUntil(
    self.registration.showNotification(data.title, {
      ...
      tag: data.tag || "rm-pocket-general",
