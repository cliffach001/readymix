...
export default function NotifToggle() {
  ...
  return (
    <button
      ...
      className="flex items-center gap-3 w-full px-3 py-2.5 rounded-xl text-sm font-medium transition-all disabled:opacity-50 hover:bg-orange-50 hover:text-[#F35b04]"
    >
      {busy ? (
