          ...
          <div className="text-center max-w-md">
            ...
            <div className="flex items-center justify-center gap-3">
              <button
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#FF6600] text-white text-sm font-medium hover:bg-orange-700 transition-colors shadow-sm"
              >
