  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        ...
        {count > 0 && (
          <span className="absolute -top-0.5 -right-0.5 flex items-center justify-center min-w-[18px] h-[18px] px-1 text-[10px] font-bold text-white bg-red-500 rounded-full ring-2 ring-[#FF6600]">
            {count > 99 ? "99+" : count}
          </span>
        )}
      </button>

      {/* Dropdown Panel — modal tengah layar */}
      {open && (
        <>
          {/* Backdrop */}
          <div
          ...
          <div className="fixed inset-0 z-[80] flex items-center justify-center p-4">
            <div className="w-full max-w-lg bg-white rounded-2xl shadow-2xl border border-gray-100 max-h-[80vh] flex flex-col">
              {/* Header */}
