  ...
  return (
    <>
      ...
      <aside className="fixed left-0 top-0 z-40 h-screen w-[var(--sidebar-width)] bg-[#FF6600] text-white flex-col hidden lg:flex">
        ...
        <div className="flex items-center gap-3 px-6 h-16 border-b border-white/10 shrink-0">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-sm font-semibold leading-tight truncate">{user.namaLengkap}</h1>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 flex lg:hidden items-center justify-around bg-[#FF6600] shadow-[0_-4px_20px_rgba(255,102,0,0.3)] px-3 py-2">
          ...
          return (
            ...
            >
              ...
              <span className="text-[10px] font-medium leading-tight">
                {item.title === "Lap. Mingguan" ? "Laporan" : item.title}
              </span>
            </Link>
          );
        })}
        ...
        <div className="flex flex-col items-center gap-0.5 px-2 py-2 min-w-16">
          <NotifikasiBell />
        </div>
        ...
        >
          <div className="w-6 h-6 rounded-full bg-white/20 flex items-center justify-center">
            <span className="text-xs font-bold text-white">{(user.namaLengkap?.charAt(0) || user.email?.charAt(0) || "?").toUpperCase()}</span>
          </div>
            ...
            <div className="p-4 flex items-center gap-3 border-b border-gray-100">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-gray-500">
                  {user.email} · {roleMeta.icon} {roleMeta.label}
                  {user.unitKerja && (
